...
const DEFAULT_WORDS = ["RADHEY", "RAMAN", "STEELS", "SINCE", "1979"]

export function ParticleTextEffect({ words = DEFAULT_WORDS, width = 1000, height = 500 }: ParticleTextEffectProps) {
