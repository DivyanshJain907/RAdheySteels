            ...
            <div className="max-w-5xl mx-auto px-4 md:px-6">
                <div className="flex justify-between items-center min-h-14 md:min-h-20">
                                    ...
                                    <NavigationMenuContent className="!w-[450px] p-4 bg-white rounded-lg">
                                        <div className="flex flex-col lg:grid grid-cols-2 gap-4">
                                            <div className="flex flex-col h-full justify-between">
                                                ...
                                                <Button size="sm" className="mt-10 bg-slate-900 hover:bg-blue-900">
                                                    Learn more
                                                </Button>
                                            </div>
                                            <div className="flex flex-col text-sm h-full justify-end space-y-2">
                                                {item.items?.map((subItem) => (
                                                    <NavigationMenuLink
                                                        href={subItem.href}
                                                        key={subItem.title}
                                                        className="flex flex-row justify-between items-center hover:bg-slate-100 py-2 px-3 rounded text-slate-900 font-medium hover:text-blue-900 transition-colors"
                                                    >
                    ...
                    <Link href="/quote" className="hidden md:block">
                        <button className="bg-yellow-400 hover:bg-yellow-500 text-slate-900 font-bold px-6 md:px-8 py-2 md:py-3 rounded-lg transition transform hover:scale-105 shadow-md text-sm md:text-base">
                            Book a Quote
                        </button>
                    </Link>
                    ...
                    <Button 
                        ...
                        className="lg:hidden text-slate-900 hover:text-blue-900"
                    >
